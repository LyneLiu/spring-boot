...
public class DateUtil {
	...
	static public Timestamp getCurrDayTime(){
		Calendar cal = Calendar.getInstance();
		cal.set(Calendar.HOUR_OF_DAY, 0);
		cal.set(Calendar.MINUTE, 0);
		cal.set(Calendar.SECOND, 0);
	...
	public static void main(String[] args) throws ParseException {
		System.out.println(DateUtil.toSimpleDate(Calendar.getInstance()).getTime());
	}
	...
	public static Calendar getStartTime4Cal(Timestamp date) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
		cal.set(Calendar.HOUR_OF_DAY, 0);
		cal.set(Calendar.MINUTE, 0);
	 ...
	 * @return 
	 */
	public static Calendar toCalendar (String strDate,String farmat){
		...
		try {
			...
			logger.error("DateUtil.toCalendar",e);
		}
		return calendar;
	}

	public static Date getAllScheduleDate(Date minDate) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(minDate);
